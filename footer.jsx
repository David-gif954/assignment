...
export default function Footer() {
  return (
    <footer className="bg-gray-950 py-4 px-6">
      <div className=" text-white flex justify-between flex-col lg:flex-row gap-20 align-center lg:w-[900px] m-auto">
        ...
        <div className="right flex flex-col gap-5">
          ...
          <h4>Keep up with the latest products releases,restocks,latest offfers and more</h4>
          <Form/>
